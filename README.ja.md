...
### ⬇️ [ClaudeMeter (.dmg) をダウンロード](https://github.com/yotake/claude-meter/releases/download/v1.1/ClaudeMeter-1.1.dmg)
...
メニューバーには選択中アカウントのセッション利用率（例: `21%`）が、消費ペース予測で色づけされて常駐表示されます。アイコンをクリックすると詳細を確認できます。
